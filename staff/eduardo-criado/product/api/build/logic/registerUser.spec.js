...
describe("registerUser", () => {
    ...
    it("fails on invalid name max length", () => {
        let errorThrown;
        try {
            registerUser("01234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890", "campo@amor.com", "campoamor", "123123123");
        }
        catch (error) {
            errorThrown = error;
        }
    ...
    it("fails on invalid email max length", () => {
        let errorThrown;
        try {
            registerUser("Campo Amor", "campo0123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789@amor.com", "campoamor", "123123123");
        }
        catch (error) {
            errorThrown = error;
        }
    ...
    it("fails on invalid username max length", () => {
        let errorThrown;
        try {
            registerUser("Campo Amor", "campo@amor.com", "0123456789012345678901234567890", "123123123");
        }
        catch (error) {
            errorThrown = error;
        }
    ...
    it("fails on invalid password max length", () => {
        let errorThrown;
        try {
            registerUser("Campo Amor", "campo@amor.com", "campoamor", "01234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890");
        }
        catch (error) {
            errorThrown = error;
        }
