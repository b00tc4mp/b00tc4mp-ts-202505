...

{
  ...
  console.assert(robot.y === 0, "robot y is 0");
  console.assert(
    (robot.orientation as Orientation) === "N",
    "robot orientation is N"
  );
}
...

{
  ...
  console.assert(robot.y === 0, "robot y is 0");
  console.assert(
    (robot.orientation as Orientation) === "S",
    "robot orientation is S"
  );
}
...

{
  ...
  console.assert(robot.y === 0, "robot y is 0");
  console.assert(
    (robot.orientation as Orientation) === "E",
    "robot orientation is E"
  );
}
...

{
  ...
  for (let i = 0; i < 10; i++) robot.forward();

  robot.left();

  for (let i = 0; i < 5; i++) robot.backward();
