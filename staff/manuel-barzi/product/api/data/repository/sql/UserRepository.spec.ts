...
describe("UserRepository (SQL)", () => {
    ...
    describe("save", () => {
        it("saves a new user", () => {
            const user: IUserData = { id: "012345678901234567890123", name: "Ed U", email: "edu@mail.com", username: "edu", password: "123123123" }
    ...
    describe("removeAll", () => {
        it("removes all users", () => {
            ...
            const user2: IUserData = { id: "012345678901234567890124", name: "Ed U 2", email: "edu2@mail.com", username: "edu2", password: "123123123" }

            const user3: IUserData = { id: "012345678901234567890125", name: "Ed U 3", email: "edu3@mail.com", username: "edu3", password: "123123123" }

            return prisma.user.createMany({ data: [user, user2, user3] })
