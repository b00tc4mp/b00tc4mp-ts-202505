...

{
    ...
    console.assert(robot.y === 0, "robot y is 0")
    console.assert(robot.orientation as "N" | "E" | "S" | "W" === "N", "robot orientation is N")
}
...

{
    ...
    console.assert(robot.x === 0, "robot x is 0")
    console.assert(robot.y === 0, "robot y is 0")
    console.assert(robot.orientation as "N" | "E" | "S" | "W" === "S", "robot orientation is S")
}
...

{
    ...
    console.assert(robot.x === 0, "robot x is 0")
    console.assert(robot.y === 0, "robot y is 0")
    console.assert(robot.orientation as "N" | "E" | "S" | "W" === "E", "robot orientation is E")
}
